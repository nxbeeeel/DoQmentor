          ...
          return (
            ...
            >
              <Card className="group">
                <div className="mb-6">
                  <div className="w-16 h-16 bg-royal-blue/10 rounded-2xl flex items-center justify-center group-hover:bg-royal-blue/20 transition-colors duration-300">
                    <IconComponent className="w-8 h-8 text-royal-blue" />
                  </div>
                </div>
                
                <h3 className="font-semibold text-lg text-charcoal mb-4 leading-tight">
                  {service.title}
                </h3>
